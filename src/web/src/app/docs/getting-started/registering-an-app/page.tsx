	...
	return (
		<article className={styles.docsPageMainContent}>
			...
			<section className={styles.introductionSection}>
				<p>
					To access the API and retrieve data about Elon University, you need to
					register an application and obtain an API key. This guide will walk
					you through the process of registering an app and obtaining the
			...
			<section aria-labelledby='Prerequisites'>
				...
				<p>
					Before registering an app with the API, make sure you have the
			...
			<section aria-labelledby='Conclusion'>
				...
				<p>
					...
					register an application with the API and retrieve your API key. This
					key is crucial for authenticating your API calls.
				</p>
				<p>
					Next, you can explore the Making API Calls section to learn how to use
					your API key to retrieve data from the API.
				</p>
				<p>
