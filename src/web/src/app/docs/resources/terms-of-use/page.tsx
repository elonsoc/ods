	...
	return (
		<article className={styles.docsPageMainContent}>
			...
			<section className={styles.introductionSection}>
				<p>
					Welcome to the Open Data Service API! Before accessing or using the
					API, please carefully read and understand the following terms and
					conditions. By accessing or using the API, you agree to be bound by
					these terms of use. If you do not agree with any part of these terms,
					please refrain from using the API.
				</p>
			</section>
			<section aria-labelledby='API_Usage'>
				...
				<p>
					...
					right to access and use the API solely for the purpose of integrating
					it into your applications or services.
				</p>
				<p>
				...
				<p>
					1.3. Acceptable Use: You agree to use the API in a manner consistent
					with applicable laws, regulations, and the intended purpose of the
					API. You shall not engage in any activities that may disrupt, damage,
					or interfere with the API or its associated systems.
				</p>
				<p>
					1.4. Prohibited Use: You shall not use the API to create or distribute
					any applications or services that are illegal, harmful, or offensive.
					You shall not use the API to create or distribute any applications or
					services that violate the rights of any third party.
				</p>
			</section>
			<section aria-labelledby='Data_Usage'>
				<h2 id='Data_Usage'>2. Data Usage</h2>
				<p>
					2.1. Data Ownership: The data provided through the API remains the
			...
			<section aria-labelledby='Intellectual_Property'>
				...
				<p>
					...
					interest in the API, including any associated documentation, code, and
					intellectual property.
				</p>
				<p>
					3.2. Attribution: When using the API, you must provide proper
					attribution to Elon University as the source of the data. The
					attribution guidelines are provided in the API documentation.
				</p>
				<p>
					3.3. Modification: You shall not modify, adapt, or alter the API in
					any way.
				</p>
				<p>
					3.4. Reverse Engineering: You shall not reverse engineer, decompile,
					or disassemble the API.
				</p>
			</section>
			<section aria-labelledby='Limitation_of_Liability'>
				<h2 id='Limitation_of_Liability'>4. Limitation of Liability</h2>
				<p>
					4.1. Warranty: The API is provided on an "as is" and "as available"
					basis. Elon University does not warrant that the API will be
					error-free, uninterrupted, or secure. Your use of the API is at your
					own risk.
				</p>
				<p>
			...
			<section aria-labelledby='Conclusion'>
				...
				<p>
					By accessing and using the API, you acknowledge that you have read,
