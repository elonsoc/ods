...
import (
	common "github.com/elonsoc/ods/src/common"
	mock "github.com/stretchr/testify/mock"

	types "github.com/elonsoc/ods/src/common/types"
)
...
func (_m *DbIFace) GetUserInformation(_a0 string) (*common.ExternalUserInformation, error) {
	ret := _m.Called(_a0)

	var r0 *common.ExternalUserInformation
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*common.ExternalUserInformation, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(string) *common.ExternalUserInformation); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*common.ExternalUserInformation)
		}
	}
