	...
	return (
		<article className={styles.docsPageMainContent}>
			...
			<section className={styles.introductionSection}>
				<p>
					When interacting with the API, it's important to be aware of potential
					error responses that you may encounter. The API service follows
					standard HTTP status codes to indicate the success or failure of a
					request.
				</p>
			</section>
