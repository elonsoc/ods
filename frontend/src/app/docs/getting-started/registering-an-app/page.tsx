	...
	return (
		<>
			...
			<div className={styles.docsPageMainContent}>
				...
				<p>
					To access the Elon ODS API and retrieve data about Elon University,
					you need to register an application and obtain an API key. This guide
					will walk you through the process of registering an app and obtaining
					the necessary information.
				</p>
				<h2 id='Prerequisites'>Prerequisites</h2>
				<p>
					Before registering an app with the Elon ODS API, make sure you have
				...
				<p>
					...
					register an application with the Elon ODS API and retrieve your API
					key. This key is crucial for authenticating your API calls.
				</p>
				<p>
