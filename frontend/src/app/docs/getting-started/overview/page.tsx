...
export default function GSOverviewPage() {
	return (
		<div className={styles.docsPageMainContent}>
			<h1>Overview</h1>
			<p>
				This guide will walk you through the process of getting started with our
				API, from logging in to retrieving your API key and making API calls. By
				following these steps, you'll be able to access the rich data about Elon
				University and build powerful applications.
			</p>
			...
			<ol>
				...
				<li>
					If you have not recently logged in to any Elon University's services,
					enter your credentials &#40;e.g. username and password&#41; and log in
			...
			<ol>
				<li>
					Go to the "Apps" link on your navigation bar on the top right of your
					page.
				</li>
				<li>
					If you are not logged in, you will be prompted to log in first before
					you have the permission to create an application.
				</li>
				<li>
